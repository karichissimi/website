...
export default function Hero() {
  ...
  return (
    <section aria-label="Introduzione investimento Karica" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24 sm:pt-28 noise">
